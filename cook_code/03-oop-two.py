...
class School(object):
    ...
    def hire(self, obj):
        ...
        print('我现在聘请了一个新老师{}'.format(obj.name))

    def enroll(self, obj):
        self.student_list.append(obj.name)
        print('我现在有了一个新学员{}'.format(obj.name))
...
class Grade(School):
    def __init__(self, school_name, grade_code, grade_course):
        ...
        print('我们现在有了{}的{}年级的{}课程'.format(self.school_name, self.code, self.course))
...
class Students(School_member):
    def __init__(self, name, age, sex, role, course):
        ...
        # zfill填充的作用，当只有一位数时前面填充0，只能对str进行操作
    ...
    def pay(self, course):
        print('我叫了300块钱学习{}'.format(course.course))
...
class Teachers(School_member):
    ...
    def teach(self, course):
        print('我来这里讲{}课了,我的id是{}'.format(course.course, self.id))
